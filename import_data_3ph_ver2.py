...
# Now we have to do an internal calculation sequence to get a "KVA" value that mimics
# the process used internally in deltrax to produce what appears in the Deltrax report
step1 = df['V1'] * df['I1']
step2 = df['V2'] * df['I2']
step3 = df['V3'] * df['I3']
...
# so numpy does not throw an error message.
